...
describe('ProductList Sagas', () => {
  ...
  test('ao chamar deleteProductListAsync com erro deve setar o erro corretamente', () => {
    ...
    expect(gen.next().value).toEqual(call(sagaLocal.deleteProductList, listId));
  ...
  test('deve chamar updateProductItemAsync corretamente', () => {
    ...
    expect(gen.next().value).toEqual(
      call(sagaLocal.updateProductItem, mockProductItem, listId),
    );
    ...
    expect(gen.next().value).toEqual(
      call(sagaServer.updateProductItem, mockProductItem, listId),
    );
